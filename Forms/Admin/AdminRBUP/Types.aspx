<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Types.aspx.cs" Inherits="RBUP.Forms.Admin.AdminRBUP.Types" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="~/Scripts/js/jquery-1.5.1.min.js"></script>
    <script src="~/Scripts/js/jquery-ui-1.8.11.custom.min.js"></script>
    <script src="~/Forms/Admin/AdminRBUP/Types.js"></script>
    ...
    <div class="ui-widget-content">
        ...
        <asp:Panel ID="Panel2" runat="server">
            <table>
                <tr>
                    <td>
                        <asp:Button ID="btnNewType" runat="server" Text="New" />
                    </td>
                    <td>
                        <asp:Button ID="btnUpdateType" runat="server" Text="Update" />
                    </td>
                    <td>
                        <asp:Button ID="btnFindType" runat="server" Text="Search" ClientIDMode="Static" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
