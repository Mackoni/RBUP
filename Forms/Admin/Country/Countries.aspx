<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Countries.aspx.cs" Inherits="RBUP.Forms.Admin.Countries" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="~/Scripts/js/jquery-1.5.1.min.js"></script>
    <script src="~/Scripts/js/jquery-ui-1.8.11.custom.min.js"></script>
    <script src="~/Forms/Admin/Country/Countries.js"></script>
    ...
    <div class="ui-widget-content">
        ...
        <asp:Panel ID="Panel2" runat="server">
            <table>
                <tr>
                    <td>
                        <asp:Button ID="btnNewCountry" runat="server" Text="New" />
                    </td>
                    <td>
                        <asp:Button ID="btnUpdateCountry" runat="server" Text="Update" />
                    </td>
                    <td>
                        <asp:Button ID="btnFindCountry" runat="server" Text="Search" ClientIDMode="Static" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
